...
(file|doc|dock) scout all: user.vscode("workbench.action.findInFiles")
(file|doc|dock) scout: user.vscode("actions.find")
(file|doc|dock) replace all: user.vscode("workbench.action.replaceInFiles")
(file|doc|dock) swap [<number_small>]:
...
line hunt [<number>]:
    ...
    insert(":")
    insert(number or "")
(file|doc|dock) hunt (pace | paste):
    user.vscode("workbench.action.quickOpen")
    sleep(50ms)
    edit.paste()
(file|doc|dock) copy name: user.vscode("fileutils.copyFileName")
(file|doc|dock) copy path: user.vscode("copyFilePath")
(file|doc|dock) copy local [path]: user.vscode("copyRelativeFilePath")
(file|doc|dock) create sibling: user.vscode_and_wait("explorer.newFile")
(file|doc|dock) create: user.vscode("workbench.action.files.newUntitledFile")
(file|doc|dock) create relative: user.vscode("fileutils.newFile")
(file|doc|dock) create root: user.vscode("fileutils.newFileAtRoot")
(file|doc|dock) create scratch:
...
(file|doc|dock) clone:
    ...
    sleep(150ms)
(file|doc|dock) delete:
    user.vscode("fileutils.removeFile")
    sleep(150ms)
(file|doc|dock) open folder: user.vscode("revealFileInOS")
(file|doc|dock) reveal: user.vscode("workbench.files.action.showActiveFileInExplorer")
...
cell continue: user.vscode("jupyter.runcurrentcelladvance")
